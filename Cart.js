...
const Cart = () => {
    ...
    const flexStyle = "d-flex justify-content-between aligh-items-center";
        ...
        <div className="cart-bg">
            <Container className="p-3">
                {cartItems.length !== 0 ? (
                    ...
                    <div  className="d-flex flex-column justify-content-center aligh-items-center"
                    style={{ minHeight: "60vh" }}>
                    <h2> No Items In the cart...!</h2>
                    <p>
                        <Link to ="/userdashboard/products"> Click Here</Link>&ndsp; to add items to cart
                    </p>
                    </div>
                )}
            </Container>
